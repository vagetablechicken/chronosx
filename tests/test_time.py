...
def test_session_start_and_end():
    ...
    assert not t2.is_trading_time()
    assert t2.raw_time.isoformat() == "2026-03-10T15:00:00+08:00"
...
def test_cme_specials():
    ...
    t1 = ChronoTime("2025-12-24T00:00:00", calendar).to_session_end()
    assert t1.raw_time.isoformat() == "2025-12-24T12:15:00-06:00"
